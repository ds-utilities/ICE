function [dec_mat,pred_mat, y_pred_whole,auc_whole]=f_dec_tab_4(X, y, clus, useParfor)
...
if useParfor == 1
    [y_pred_whole, auc_whole] = f_weka_RF_arff_k_fo_3_parfor(X, y, fo_inner);
else
...
[y_pred_multi]=f_use_each_clus_forWhole(X, y, clus, y_pred_whole, useParfor);
