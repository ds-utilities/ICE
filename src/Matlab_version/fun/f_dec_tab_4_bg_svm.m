function [err_mat,pred_prob_mat, y_pred_whole,auc_whole]=...
    f_dec_tab_4_bg_svm(X, y, clus, useParfor)
...
% if useParfor == 1
[y_pred_whole, auc_whole] = f_weka_bg_svm_arff_k_fo_3_parfor(X, y, fo_inner);
...
[y_pred_multi]=f_use_each_clus_forWhole_bg_svm(X, y, clus, y_pred_whole, useParfor);
